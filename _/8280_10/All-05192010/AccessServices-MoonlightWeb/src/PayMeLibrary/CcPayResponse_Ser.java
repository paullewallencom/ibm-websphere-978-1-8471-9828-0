...
public class CcPayResponse_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public CcPayResponse_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        CcPayResponse bean = (CcPayResponse) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propQName = QName_0_7;
          propValue = bean.getRejection();
          serializeChild(propQName, null, 
              propValue, 
              QName_2_10,
              false,null,context);
          propQName = QName_0_8;
          propValue = bean.getOrigRequest();
          serializeChild(propQName, null, 
              propValue, 
              QName_2_11,
              false,null,context);
