...
public class WashingtonCreditAgencyImpl {
	/**
	 * Default constructor.
	 */
	public WashingtonCreditAgencyImpl() {
		super();
	}
	...
	public DataObject requestCreditApproval(String customerInfo) {
		...
		customerCreditApproval.setString("id",customerInfo);
		...
		customerCreditApproval.setString("ratingAgency","Washington Rating Agency");
